...
import Controlador.CtrlProviders;
import Controlador.CtrlTables;
import Controlador.CtrlUsers;
...
public class home extends javax.swing.JFrame {
    ...
    private void btnUsersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsersActionPerformed
        ...
        if (frmUser == null) {
            Users mod = new Users();
            UsersDAO modC = new UsersDAO();
            frmUser = new frmUsers();
            CtrlUsers ctrl = new CtrlUsers(mod, modC, frmUser);
            ctrl.iniciar();
    ...
    private void btnMesasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMesasActionPerformed
        ...
        if (frmTable == null) {
            ...
            TablesDAO modC = new TablesDAO();
            frmTable = new frmTables();
            CtrlTables ctrl = new CtrlTables(mod, modC, frmTable);
            ctrl.iniciar();
    ...
    private void btnProvidersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProvidersActionPerformed
        // TODO add your handling code here:
        if (frmProvider == null) {
            Providers mod = new Providers();
            ProvidersDAO modC = new ProvidersDAO();
            frmProvider = new frmProviders();
            CtrlProviders ctrl = new CtrlProviders(mod, modC, frmProvider);
            ctrl.iniciar();
